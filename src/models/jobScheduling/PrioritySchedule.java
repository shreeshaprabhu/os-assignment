...
public class PrioritySchedule extends JobSchedule
{
    private ArrayList<RunningProcess> processList;

    public PrioritySchedule(Set<? extends Job> jobs)
    {
    ...
    void solve(Set<? extends Job> jobs)
    {
        ...
        PriorityQueue<Job> queue = new PriorityQueue<>(Job::comparePriority);
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        System.out.println("Enter the arrival time, burst time and priority of each job");
        for (int i = 1; i <= n; i++)
            jobs.add(new Job(i, scr.nextLong(), scr.nextLong(), scr.nextLong()));

        JobSchedule ps = new PrioritySchedule(jobs);
        System.out.println("Average Turn Around Time: " + ps.averageTurnAroundTime());
        System.out.println("Average Waiting Time: " + ps.averageWaitingTime());
